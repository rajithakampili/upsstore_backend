...
let responseData;
let DB_NAME = "UPSSTORE";
let COLLECTION_NAME = "PACKING_SHIPPING"
async function main() {
    const uri = `mongodb+srv://rkampili1990:Unh2023@cluster0.6knviam.mongodb.net/${DB_NAME}?retryWrites=true&w=majority`;
